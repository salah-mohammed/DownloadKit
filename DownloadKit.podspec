...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/salah-mohammed/DownloadKit"
  ...
  s.source       = { :git => "https://github.com/salah-mohammed/DownloadKit.git", :tag => "#{s.version}",:branch => "master"}
...
#s.vendored_frameworks = 'Realm.xcframework','RealmSwift.xcframework'

s.vendored_frameworks = 'Products/Realm.framework','Products/RealmSwift.framework'
