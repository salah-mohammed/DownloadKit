...
class LocalFileViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        downloadService =  FileDownloadService.init(url: URL.init(string:"https://ia802302.us.archive.org/27/items/Pbtestfilemp4videotestmp4/video_test.mp4")!,.background)
        downloadService?.fileType = "mp4";
        downloadService?.folderName = "Downloads";
